...
<div class="container">
    ...
    <form:form action="/san-pham/add" method="post" modelAttribute="sanPham" enctype="multipart/form-data">
<%--        <div class="form-group">--%>
<%--            <label for="image">Image:</label>--%>
<%--            <input type="file" id="image" name="photo"accept="photo/*" class="form-control-file"> <br>--%>
<%--        </div>--%>
        ...
        <a href="/san-pham/hien-thi" class="btn btn-danger">Quay lại</a>
